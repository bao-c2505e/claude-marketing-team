...
export const SEED_CLIENTS: Client[] = [
  ...
  },
  {
    ...
    contact_email: 'hello@mocan.vn',
    contact_phone: null,
    status: 'active' as ResourceStatus,
    notes: 'Cà phê đặc sản, chuỗi quán tại HCM và HN. Target: dân văn phòng & người yêu cà phê specialty.',
    created_by: 'demo-owner-000',
    created_at: NOW,
    updated_at: NOW,
  },
...
export const SEED_BRANDS: Brand[] = [
  ...
  {
    id: 'brand-moc-an',
    client_id: 'client-moc-an',
    name: 'Mộc An Coffee',
    slug: 'moc-an-brand',
    industry: 'F&B / Specialty Coffee',
    hero_product: 'Cold Brew đặc sản Series S1',
    tone_of_voice: 'Tinh tế, hiện đại, ấm áp nhưng gần gũi',
    target_audience: 'Dân văn phòng & người yêu cà phê specialty 25–45 tuổi tại HCM/HN',
    primary_channels: ['Facebook', 'Instagram', 'YouTube'],
    brand_colors: { primary: '#3a2417', secondary: '#c9a84c' },
    logo_url: null,
    status: 'active' as ResourceStatus,
    created_by: 'demo-owner-000',
    created_at: NOW,
...
export const SEED_CAMPAIGNS: Campaign[] = [
  ...
  {
    id: 'campaign-moc-an-s1',
    brand_id: 'brand-moc-an',
    client_id: 'client-moc-an',
    name: 'Cold Brew S1 Launch Campaign',
    description: 'Ra mắt dòng Cold Brew đặc sản Series S1, target dân văn phòng & người yêu cà phê specialty. Kênh chính: Facebook, Instagram, YouTube.',
...
export const SEED_BRIEFS: CampaignBrief[] = [
  ...
  {
    id: 'brief-moc-an-s1',
    campaign_id: 'campaign-moc-an-s1',
    brand_id: 'brand-moc-an',
    client_id: 'client-moc-an',
    brand_name: 'Mộc An Coffee',
    brief_title: 'Brief Cold Brew S1 Launch Campaign',
    campaign_goal: 'Ra mắt dòng Cold Brew đặc sản Series S1, xây dựng nhận thức thương hiệu cà phê specialty, thu lead & tăng lượt ghé quán tại HCM và HN.',
    hero_product: 'Cold Brew đặc sản Series S1',
    product_focus: 'Cold Brew đặc sản Series S1 – hạt cà phê specialty chọn lọc, ủ lạnh 18 giờ, 3 hương vị signature, đóng chai mang đi. Giá & quy cách: [Owner xác nhận].',
    offer: 'Ưu đãi ra mắt 30 ngày đầu: dùng thử miễn phí 3 vị tại quán + ưu đãi combo cho đơn mang đi. Chi tiết & mức giảm: [Owner xác nhận].',
    industry: 'F&B / Specialty Coffee',
    tone: 'Tinh tế, ấm áp',
    tone_of_voice: 'Tinh tế, hiện đại, ấm áp nhưng gần gũi. Không lạm dụng từ "đẳng cấp" hay "luxury" – thay bằng "cà phê thật", "vị pha để thưởng thức".',
    target_audience: 'Dân văn phòng 25–45 tuổi, người yêu cà phê specialty, dân sáng tạo tại HCM (Q1, Q3, Thủ Đức) và HN (Tây Hồ, Cầu Giấy).',
    campaign_goals: ['Ra mắt dòng Cold Brew S1', 'Thu lead & tăng lượt ghé quán HCM & HN', 'Xây dựng brand equity specialty coffee'],
    key_messages: ['Pha để thưởng thức – không chỉ để check-in', 'Hạt specialty thật – ủ lạnh chuẩn', 'Ủ lạnh 18 giờ – vị êm, hậu ngọt'],
    channels: ['Facebook', 'Instagram', 'YouTube'],
    content_pillars: ['Product showcase', 'Specialty coffee culture', 'Nguồn gốc hạt & cách ủ', 'Khách hàng & không gian quán', 'Trải nghiệm tại quán'],
    must_include: 'Hình ảnh chụp tại quán thật. Video pha/ủ cold brew. Thông tin các quán HCM + HN.',
    must_avoid: 'Tránh so sánh giá trực tiếp với đối thủ. Không claim giải thưởng/chứng nhận chưa có. Không dùng ảnh ly cà phê cẩu thả.',
    competitors: 'The Coffee House, Phúc Long (phân khúc phổ thông), các quán specialty coffee độc lập tại HCM/HN.',
    reference_links: null,
...
export const SEED_COLLECTIONS: LocalAssetCollection[] = [
  ...
  },
  {
    ...
    brand_id: 'brand-moc-an',
    campaign_id: null,
    name: 'Mộc An Coffee — Brand Guidelines & Assets',
    description: 'Brand guideline, product photography, marketing assets specialty coffee.',
    created_by: 'demo-owner-000',
    created_at: NOW,
    updated_at: NOW,
  },
...
export const SEED_ASSETS: AssetItem[] = [
  ...
  },
  {
    ...
    generation_job_id: null,
    content_item_id: null,
    asset_collection_id: 'col-moc-an-brand',
    name: 'Mộc An Coffee Brand Guideline 2026',
    asset_type: 'document',
    source_type: 'local_placeholder',
    url: null,
    thumbnail_url: null,
    file_name: 'moc-an-coffee-brand-guideline-2026.pdf',
    file_size_note: '~15MB PDF',
    mime_type: 'application/pdf',
    tags: ['brand-guideline', 'official-document', 'typography', 'colors', 'logo-usage'],
    usage_rights_note: 'Tài liệu nội bộ Mộc An Coffee. Bảo mật — không chia sẻ ra bên ngoài. Chỉ dùng trong team The Core Agency khi phục vụ Mộc An Coffee.',
    approval_status: 'approved',
    notes: 'Brand guideline chính thức Mộc An Coffee 2026. Bao gồm typography, màu sắc, quy tắc dùng logo, tone of voice. Cần owner Mộc An Coffee confirm version mới nhất.',
    created_by: 'demo-owner-000',
    created_at: NOW,
    updated_at: NOW,
  },
  {
    id: 'asset-moc-an-coffee-ref',
    client_id: 'client-moc-an',
    brand_id: 'brand-moc-an',
    campaign_id: 'campaign-moc-an-s1',
    brief_id: null,
    ...
    content_item_id: null,
    asset_collection_id: 'col-moc-an-brand',
    name: 'Cold Brew S1 — Lifestyle Photography Brief',
    asset_type: 'reference',
    source_type: 'local_placeholder',
    url: null,
    thumbnail_url: null,
    file_name: 'cold-brew-s1-photo-brief.pdf',
    file_size_note: '~2MB PDF',
    mime_type: 'application/pdf',
    tags: ['reference', 'photo-brief', 'lifestyle', 'cold-brew-s1'],
    usage_rights_note: 'Tài liệu brief nội bộ. Quyền sở hữu ảnh thuộc về Mộc An Coffee sau khi chụp. Cần hợp đồng nhiếp ảnh trước khi sử dụng thương mại.',
    approval_status: 'needs_review',
    notes: 'Brief hướng dẫn phong cách chụp ảnh lifestyle cho Cold Brew Series S1. Không gian quán hiện đại, ánh sáng tự nhiên, người trẻ sành cà phê. Cần manager review.',
    created_by: 'demo-owner-000',
    created_at: NOW,
    updated_at: NOW,
  },
