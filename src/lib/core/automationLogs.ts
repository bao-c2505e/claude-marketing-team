...
export const SEED_AUTOMATION_LOGS: LocalAutomationLog[] = [
  ...
  },
  {
    ...
    severity:   'success',
    status:     'recorded',
    title:      'Content Generation — Vị Cuốn Campaign Completed (n8n AI Provider)',
    message:    'Content generation job completed for campaign "Heo Quay Mùa Hè 2026" via n8n AI Provider. 7 pending approval items created. Nothing was posted or launched — content ready for human review.',
    payload_preview: '{"job_id":"cf-job-001","campaign":"Heo Quay Mùa Hè 2026","items_generated":7,"mode":"external_module","source":"n8n","generated_by":"n8n-ai-provider"}',
  ...
  },
  {
    ...
    severity:   'info',
    status:     'recorded',
    title:      'Analytics Report Generated — Cold Brew S1 Launch Campaign',
    message:    'Mock analytics intelligence report generated for "Cold Brew S1 Launch Campaign". Period: 2026-06. 4 items approved, 3 pending. No real analytics data — sample metrics only.',
    payload_preview: '{"report_type":"campaign_progress","campaign":"Cold Brew S1 Launch Campaign","period":"2026-06","items_approved":4,"items_pending":3,"source":"mock"}',
    related_connector_id:    'conn-n8n',
