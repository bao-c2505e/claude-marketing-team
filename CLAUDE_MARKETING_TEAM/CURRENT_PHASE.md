...
- **Mới nhất:** **V2-D1 (Owner naming) — Supabase Staging Audit & Runbook** ✅ DONE (2026-06-12) — audit/docs only, xem section bên dưới. **V2-D2 (staging execution) 🔴 NOT STARTED — cần Owner approval (checkpoint A) TRƯỚC khi tạo staging project hoặc chạy bất kỳ SQL nào.** *(Naming note: trong roadmap, Supabase staging hardening vốn là roadmap-V2-B — theo naming của Owner: V2-D1 = audit/runbook, V2-D2 = execution.)*
- **Tiếp theo:** Owner xem runbook → nếu duyệt, log checkpoint A → V2-D2 thực thi §4 checklists. Các package khác còn mở: V2-E (UI polish/code-splitting), roadmap-V2-C n8n dry-run + V2-F connector plan (Owner-gated; PC2 paused at N11).
