...
### Checkpoint C — Client-Feedback Policy (🟡 DOCS/SPEC PROPOSED — 2026-06-15):
- **Kết quả:** Checkpoint C được author **docs/spec only** (Owner-approved scope). Trước đó NOT STARTED → tạo mới, không duplicate. **Status: 🟡 PROPOSED / NOT implemented.**
...
- **Checkpoint D:** 🔴 **NOT STARTED / Owner-gated** — implementation (table/RLS/UI) là future phase, theo sau một Checkpoint B *VERIFIED* (hiện BLOCKED).
