...
- **Mới nhất:** **V2-D1.5 — Manual E2E Checklist + Demo Script (docs-only prep)** ✅ DONE (2026-06-12) — hai runbook mới trong `CLAUDE_MARKETING_TEAM/07_runbooks/` chuẩn bị cho manual E2E verification, xem section bên dưới. **V2-D2 vẫn 🔴 NOT STARTED / Owner-gated.** Đã cập nhật wording trạng thái PC2 từ "paused at N11" → "N12 post-merge cleanup" ở các chỗ chỉ là status label (không đổi contract).
